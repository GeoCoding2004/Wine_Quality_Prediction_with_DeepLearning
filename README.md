...
<br> Example: If the user wants to use the fixed acidity as input for the neural network, and wants the quality of the wine as output, the following function shows an example to extract the required data: input_tensor, output_tensor = Data_set(filename, ['fixed acidity',....], ['quality']) <br>
